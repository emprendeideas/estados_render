...
def iniciar_telegram():
    ...
    async def run():
        ...
        try:
            ...
            print("🔌 Conectando Telegram...")

            await telegram.connect()

            autorizado = await telegram.is_user_authorized()

            if not autorizado:

                print("❌ SESSION_STRING inválida o expirada")
                return
