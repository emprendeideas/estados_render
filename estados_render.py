...
for dia in dias:
    ...
    scheduler.add_job(
        lambda: asyncio.run(publicar_story()),
        CronTrigger(
            day_of_week=dia,
            hour=hora,
            minute=minuto,
...
# =========================================
# 🔹 MAIN TELEGRAM (CORREGIDO Y ESTABLE)
# =========================================
...
def main():
    ...
    # =========================================
    # 🔹 CONEXIÓN TELEGRAM (ESTILO CORRECTO COMO TU OTRO BOT)
    # =========================================
    ...
    # =========================================
    # 🔹 INICIAR SCHEDULER (DENTRO DEL LOOP REAL)
    # =========================================
    ...
    # =========================================
    # 🔹 PROGRAMAR TASK DE STORIES (SIN asyncio.run)
    # =========================================

    async def stories_loop():
        while True:
            await asyncio.sleep(60)

    telegram.loop.create_task(stories_loop())
