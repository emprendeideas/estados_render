...
📩 Escríbeme y te explico cómo puedes empezar""",
...
📩 Escríbeme y te ayudo a comenzar""",
...
📩 Escríbeme y te explico cómo acceder"""
            ]
...
📩 Escríbeme y te explico cómo funciona""",
...
📩 Escríbeme y te muestro cómo participar""",
...
📩 Escríbeme y te explico los detalles"""
            ]
...
📩 Escríbeme y te explico cómo entrar""",
...
📩 Escríbeme y te ayudo a empezar""",
...
📩 Escríbeme y te paso los detalles"""
        ...
        # =========================================
        # 🔹 ADAPTAR IMAGEN HORIZONTAL
        # =========================================

        img = Image.open("story_temp.jpg").convert("RGB")
        ...
        if ancho > alto:
            ...
            print("🖼️ Imagen horizontal detectada")
            ...
            print("✅ Imagen adaptada para story")

        else:

            print("✅ Imagen vertical detectada")
