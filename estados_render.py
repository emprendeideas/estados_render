    ...
    try:
        ...
        if tipo == "pagos":
            ...
            textos_pagos = [
                ...
                f"""
        🎉 Más usuarios adquieren nuestras [Herramientas Premium](https://beacons.ai/nanomillenial) 🚀

        Hoy {fecha} seguimos sumando clientes satisfechos ✅
        """,

                f"""
        🚀 Nuevos usuarios están ingresando a nuestras
        [Herramientas Premium](https://beacons.ai/nanomillenial) 📈

        Hoy {fecha} continúa creciendo la comunidad 🔥
        """,

                f"""
        💎 Más personas están obteniendo acceso a nuestras
        [Herramientas Premium](https://beacons.ai/nanomillenial) 🚀
        ...
        """
            ...
            textos_fdi = [
                ...
                f"""
        💸 Nuevos pagos enviados desde el
        ...
        """,
                ...
                f"""
        🔥 Nuevos comprobantes de pago del
        [Fondo de Inversión FDI](https://t.me/inversionesFDI) 📈
        ...
        """,
                ...
                f"""
        🚀 Más usuarios están ingresando a
        [CopyTrade](https://t.me/CopyTradePocket) 📊

        Hoy {fecha} continúan llegando nuevos resultados 🔥
        """,
